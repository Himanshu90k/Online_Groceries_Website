const LocationPage = () => {
    ...
    return (
        <div className="flex flex-col items-center bg-white min-w-78 max-w-300 h-screen md:h-fit 2xl:h-screen mx-2 md:mx-4 lg:mx-9 xl:mx-auto justify-start">
            {/* heading */}
            <div className="w-full h-10 lg:h-20 bg-customRed flex items-center justify-center">
                <h1 className="text-white font-inter text-sm lg:text-4xl font-extrabold">YOUR LOCATION</h1>
            </div>
            ...
            <div className="w-full px-5 sm:px-10 md:px-16 h-fit">
                ...
                {/* location buttons */}
                <div className="w-full h-fit mb-8 lg:mb-12 flex justify-between items-center">
                    <div className="h-full flex items-center gap-2 lg:gap-7">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 lg:w-16 h-6 lg:h-16" width="64" height="64" viewBox="0 0 64 64" fill="none">
                            <path
                        ...
                        <h3 className="text-customRed font-inter font-semibold text-xs lg:text-3.5xl">Current location</h3>
                    </div>

                    <button type="button" title="enable" className="text-black font-inter text-xs lg:text-3.5xl font-bold w-20 lg:w-56 h-6 lg:h-16 rounded-4-xl border-2 lg:border-4 border-solid border-customRed">
                        Enable
                    </button>
                </div>

                {/* break */}
                <svg xmlns="http://www.w3.org/2000/svg" className="w-full stroke-2" height="3" viewBox="0 0 1242 3" fill="none">
                    <path d="M1 1.5L1241 1.50011" stroke="black" strokeOpacity="0.6" strokeLinecap="round" />
                </svg>

                {/* saved locations */}
                <div className="w-full h-auto flex flex-col items-start my-4 lg:my-9">
                    <h2 className="text-customBlack font-inter text-sm lg:text-2xl font-semibold mb-4 lg:mb-7">Saved Locations</h2>

                    {/* home location */}
                    <div className="flex flex-col items-start gap-1 lg:gap-2 mb-3 lg:mb-8">
                        <div className="flex items-center gap-2 lg:gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 lg:w-7 h-4 lg:h-28px" viewBox="0 0 28 28" fill="none">
                                <path
                            ...
                            <p className="text-black font-inter text-xs lg:text-xl font-bold lg:font-extrabold">Home</p>
                        </div>

                        <p className="pl-6 lg:pl-10 text-black font-inter text-xxs lg:text-base font-medium">near Shitla Devi Mandir, Chembur Colony, Chembur,<br className="md:block hidden" /> Mumbai, Maharashtra India.</p>
                    </div>
                    ...
                    <div className="flex flex-col items-start gap-1 lg:gap-2 mb-3 lg:mb-8">
                        <div className="flex items-center gap-2 lg:gap-3">
                            ...
                            <p className="text-black font-inter text-xs lg:text-xl font-bold lg:font-extrabold">Office</p>
                        </div>
                    ...
                    <div className="flex flex-col items-start gap-2">
                        <div className="flex items-center gap-2 lg:gap-3">
                            ...
                            <p className="text-black font-inter text-xs lg:text-xl font-bold lg:font-extrabold">Friends & Family</p>
                        </div>
                ...
                {/* recent searches */}
                <div className="w-full h-auto flex flex-col items-start my-4 lg:my-9">
                    <h2 className="text-customBlack font-inter text-sm lg:text-2xl font-semibold mb-4 lg:mb-7">Recent Searches</h2>
                    ...
                    <div className="flex flex-col items-start gap-1 lg:gap-2 mb-3 lg:mb-8">
                        <div className="flex items-center gap-2 lg:gap-3">
                            ...
                            <p className="text-black font-inter text-xs lg:text-xl font-bold lg:font-extrabold">Wadala West</p>
                        </div>
