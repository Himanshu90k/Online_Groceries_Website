    ...
    return (
        <div className="flex items-center gap-24 my-4">
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-center justify-center w-16 h-16 rounded-4-xl border-2 border-solid border-customYellow bg-customRed">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="38" viewBox="0 0 32 38" fill="none">
                        <path d="M16 15.5C19.866 15.5 23 12.366 23 8.5C23 4.63401 19.866 1.5 16 1.5C12.134 1.5 9 4.63401 9 8.5C9 12.366 12.134 15.5 16 15.5Z" stroke="white" strokeWidth="3" />
                        <path d="M30 28.625C30 32.9737 30 36.5 16 36.5C2 36.5 2 32.9737 2 28.625C2 24.2763 8.2685 20.75 16 20.75C23.7315 20.75 30 24.2763 30 28.625Z" stroke="white" strokeWidth="3" />
                    </svg>
                </div>
                <div className="flex flex-col items-start gap-6-px">
                    <div className="flex gap-2 items-center">
                        <h2 className="text-black font-inter text-xl font-semibold">Welcome Guest</h2>
                        <p className="text-customRed font-inter text-xl font-medium">( Login )</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {/* address */}
                        <div className="flex items-center gap-2">
                            <p className="text-black font-inter text-sm font-medium">Deliver to 400071</p>
            ...
            <div className="flex items-center gap-4">
                {/* search */}
                <div className="h-10 w-120 bg-lightRed rounded">
                    <input
                        type="search"
                        title="search"
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center justify-center w-11 h-11 border-2 border-solid border-customYellow rounded-3xl bg-customRed">
